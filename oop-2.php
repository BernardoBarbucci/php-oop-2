...
if ($currentCategory === 'dog') {
    $filteredToys = $dogToys;
    $filteredBeds = $dogBeds;
} elseif ($currentCategory === 'cat') {
    $filteredToys = $catToys;
    $filteredBeds = $catBeds;
} else {
    // mostra tutto di default
    $filteredToys = array_merge($dogToys, $catToys);
    $filteredBeds = array_merge($dogBeds, $catBeds);
}
        ...
        <main>
            <section class="container-fluid">
                <div class="mb-4">
                    <form method="get" action="">
                        <select class="form-select border border-warning ms-2" name="category"
                            aria-label="Default select example" style="width: 15rem;" onchange="this.form.submit()">
            ...
            <section class="container-fluid">
                <div class="row p-3 d-flex justify-content-center">
                    ...
                    <!-- cat items  -->
                    <?php foreach ($filteredToysCat as $catToy) : ?>
                    ...
                    <!-- cat beds -->
                    <?php foreach ($filteredBedsCat as $catBed) : ?>
